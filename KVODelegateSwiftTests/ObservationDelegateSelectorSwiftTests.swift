...
class ObservationDelegateSelectorSwiftTests: XCTestCase {
    ...
    // TOMORROW: Finish these tests and the notification delegate tests, then
    //           refine interfaces for Swift to convert change dictionaries into
    //           `NSKeyValueObservedChange`s
